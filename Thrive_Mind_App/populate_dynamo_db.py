...
if not HealthcareServiceModel.exists():
    ...
    service1 = HealthcareServiceModel(str(uuid.uuid4()), name="healthcareservice1", description="This is a description of healthcare service 1", email_address="service1@healthcare.com", phone="(101) 301-0485", is_accepting=True)
    service2 = HealthcareServiceModel(str(uuid.uuid4()), name="healthcareservice2", description="This is a description of healthcare service 2", email_address="service2@healthcare.com", phone="(202) 321-2485", is_accepting=False)
    service3 = HealthcareServiceModel(str(uuid.uuid4()), name="someotherservice", description="This is a description of a different service", email_address="service3@somethingelse.com", phone="(666) 666-6666", is_accepting=True)
